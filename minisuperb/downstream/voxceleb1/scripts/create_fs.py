...
def get_args():
    ...
    parser.add_argument('--metadata', type=str, default='downstream/voxceleb1/mini_veri_test_class.txt')
...
if __name__ == '__main__':
    ...
    # part_train_df = train_df.groupby('spk', group_keys=False).apply(lambda x: x.sample(1, random_state=args.seed))
