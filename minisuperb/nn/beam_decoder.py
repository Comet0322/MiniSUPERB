...
class BeamDecoder(object):
    ...
    def __init__(
        ...
        try:
            ...
            logger.error(
                f"Please install flashlight to enable {__class__.__name__}")
            raise
        ...
        for word, spellings in self.lexicon.items():
            ...
            for spelling in spellings:
                spelling_idxs = [
                    self.token_dict.get_index(tok) for tok in spelling
                ]
        ...
        for b in range(B):
            ...
            hyps.append([
                dict(
                    ...
                    words=[
                        self.word_dict.get_entry(x) for x in result.words
                        if x >= 0
                    ],
