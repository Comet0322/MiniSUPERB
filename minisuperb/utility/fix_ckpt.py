...
def main():
    ...
    from minisuperb.upstream.mockingjay.model import TransformerForMaskedAcousticModel
    model = TransformerForMaskedAcousticModel(old_transformer.model_config,
                                              old_transformer.inp_dim,
                                              old_transformer.inp_dim).to(
                                                  torch.device('cuda'))
