...
import minisuperb
from minisuperb.upstream.hubert.hubert_model import (
    HubertConfig,
    HubertModel,
    HubertPretrainingConfig,
)
from minisuperb.upstream.utils import load_fairseq_ckpt, merge_with_parent
from minisuperb.util.download import _urls_to_filepaths


def load_and_convert_fairseq_ckpt(fairseq_source: str,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir",
                        default=Path(minisuperb.__file__).parent.parent /
                        "converted_ckpts")
    ...
    load_and_convert_fairseq_ckpt(
        args.fairseq_ckpt,
        Path(args.output_dir) / f"{Path(args.fairseq_ckpt).stem}.pt")
