...
def tera_url(ckpt, refresh=False, *args, **kwargs):
    ...
    The model from URL
        ckpt (str): URL
    """
    return tera_local(_urls_to_filepaths(ckpt, refresh=refresh), *args,
                      **kwargs)
...
def tera_960hr(refresh=False, *args, **kwargs):
    ...
    The tera base model on 960hr
        refresh (bool): whether to download ckpt/config again if existed
    """
    return tera_logMelBase_T_F_M_AdamW_b32_1m_960hr_drop1(
        refresh, *args, **kwargs)
...
def tera_logMelBase_T_F_AdamW_b32_200k_100hr(refresh=False, *args, **kwargs):
    ...
    """
    kwargs[
        "ckpt"] = "https://www.dropbox.com/s/o36qt1zgtn3tsep/states-200000.ckpt?dl=1"
...
def tera_logMelBase_T_F_M_AdamW_b32_200k_100hr(refresh=False, *args, **kwargs):
    ...
    """
    kwargs[
        "ckpt"] = "https://www.dropbox.com/s/l9ryl82k64m1lsk/states-200000.ckpt?dl=1"
    return tera_url(refresh=refresh, *args, **kwargs)
...
def tera_logMelBase_T_F_AdamW_b32_1m_960hr(refresh=False, *args, **kwargs):
    ...
    """
    kwargs[
        "ckpt"] = "https://www.dropbox.com/s/98olxex0m7oy9ta/states-1000000.ckpt?dl=1"
    return tera_url(refresh=refresh, *args, **kwargs)


def tera_logMelBase_T_F_AdamW_b32_1m_960hr_drop1(refresh=False,
                                                 *args,
                                                 **kwargs):
    """
    Feature: 80-dim log Mel
    ...
    """
    kwargs[
        "ckpt"] = "https://www.dropbox.com/s/2ekbt2gxlkbvfz0/states-1000000.ckpt?dl=1"
    return tera_url(refresh=refresh, *args, **kwargs)


def tera_logMelBase_T_F_AdamW_b32_1m_960hr_seq3k(refresh=False,
                                                 *args,
                                                 **kwargs):
    """
    Feature: 80-dim log Mel
    ...
    """
    kwargs[
        "ckpt"] = "https://www.dropbox.com/s/tfysinbalpm3gsj/states-1000000.ckpt?dl=1"
    return tera_url(refresh=refresh, *args, **kwargs)


def tera_logMelBase_T_F_M_AdamW_b32_1m_960hr_drop1(refresh=False,
                                                   *args,
                                                   **kwargs):
    """
    Feature: 80-dim log Mel
    ...
    """
    kwargs[
        "ckpt"] = "https://www.dropbox.com/s/xdoj9wdo87lztv1/states-1000000.ckpt?dl=1"
    return tera_url(refresh=refresh, *args, **kwargs)
...
def tera_fbankBase_T_F_AdamW_b32_200k_100hr(refresh=False, *args, **kwargs):
    ...
    """
    kwargs[
        "ckpt"] = "https://www.dropbox.com/s/i32ob29m6afufot/states-200000.ckpt?dl=1"
    return tera_url(refresh=refresh, *args, **kwargs)
