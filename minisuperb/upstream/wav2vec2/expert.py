...
from minisuperb.utility.helper import zero_mean_unit_var_norm
...
class LegacyUpstreamExpert(UpstreamBase):
    ...
    def __init__(self, ckpt, **kwargs):
        logger.warning(
            "Use the legacy expert for wav2vec 2.0 which depends on fairseq")
    ...
    def load_model(ckpt_path: str):
        ...
        def fix_cfg(cfg):
            ...
            fields_pretraining = [
                field.name
                for field in dataclasses.fields(AudioPretrainingConfig)
            ]
