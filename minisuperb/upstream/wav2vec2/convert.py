...
from minisuperb.upstream.wav2vec2.wav2vec2_model import (
...
def load_converted_model(ckpt: str):
    ...
    task_cfg = merge_with_parent(AudioPretrainingConfig,
                                 ckpt_state["task_cfg"])
...
if __name__ == "__main__":
    ...
    load_and_convert_fairseq_ckpt(args.fairseq_ckpt,
                                  Path(args.output_dir) / f"{stem}.pt")
