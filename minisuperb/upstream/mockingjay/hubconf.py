...
def mockingjay_100hr(refresh=False, *args, **kwargs):
    ...
    The mockingjay base model on 100hr
        refresh (bool): whether to download ckpt/config again if existed
    """
    return mockingjay_logMelBase_T_AdamW_b32_200k_100hr(refresh=refresh,
                                                        *args,
                                                        **kwargs)
...
def mockingjay_960hr(refresh=False, *args, **kwargs):
    ...
    The mockingjay base model on 960hr
        refresh (bool): whether to download ckpt/config again if existed
    """
    return mockingjay_logMelBase_T_AdamW_b32_1m_960hr_drop1(refresh=refresh,
                                                            *args,
                                                            **kwargs)
...
def mockingjay_logMelBase_T_AdamW_b32_200k_100hr(refresh=False,
                                                 *args,
                                                 **kwargs):
    """
    ...
    """
    kwargs[
        "ckpt"] = "https://www.dropbox.com/s/luorglf8mdg67l2/states-200000.ckpt?dl=1"
...
def mockingjay_logMelLinearLarge_T_AdamW_b32_500k_360hr_drop1(
    ...
    """
    kwargs[
        "ckpt"] = "https://www.dropbox.com/s/zwsfa6w2iy2cc68/states-500000.ckpt?dl=1"
    return mockingjay_url(refresh=refresh, *args, **kwargs)
...
def mockingjay_logMelBase_T_AdamW_b32_1m_960hr(refresh=False, *args, **kwargs):
    ...
    """
    kwargs[
        "ckpt"] = "https://www.dropbox.com/s/jzx0xggk663jev6/states-1000000.ckpt?dl=1"
    return mockingjay_url(refresh=refresh, *args, **kwargs)


def mockingjay_logMelBase_T_AdamW_b32_1m_960hr_drop1(refresh=False,
                                                     *args,
                                                     **kwargs):
    """
    Feature: 80-dim log Mel
    ...
    """
    kwargs[
        "ckpt"] = "https://www.dropbox.com/s/7f9z6dzc7oix6qv/states-1000000.ckpt?dl=1"
    return mockingjay_url(refresh=refresh, *args, **kwargs)


def mockingjay_logMelBase_T_AdamW_b32_1m_960hr_seq3k(refresh=False,
                                                     *args,
                                                     **kwargs):
    """
    Feature: 80-dim log Mel
    ...
    """
    kwargs[
        "ckpt"] = "https://www.dropbox.com/s/qnnvdrai2tfmjmh/states-1000000.ckpt?dl=1"
    return mockingjay_url(refresh=refresh, *args, **kwargs)
